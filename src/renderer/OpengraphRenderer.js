    ...
    let body = ''
		if (image) {
			body += `<div style="width:100px; height:100px; overflow:hidden; display:flex; justify-content: center;align-items: center; background-color: #000;">
				<a href="${url}" style="width:100px;height:100px;"><img style="max-width:100%; max-height:100%" src="${image}"></a>
			</div>`
		}
		...
		return `<div style="position:relative; max-width:470px; height:100px; box-shadow:0 1px 5px #999; margin: 10px auto 30px;"
