...
class OpengraphRenderer {
	...
	renderSummary() {
		...
		body += `<div style="width:470px; padding:10px; box-sizing:border-box">
			<a style="display:block; font-weight:500; font-size:18px; overflow: hidden; word-wrap: break-word; line-height:25px; text-overflow: ellipsis; white-space:nowrap">${title}</a>
